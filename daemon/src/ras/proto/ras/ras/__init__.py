...
# sources: auth.proto, daemon.proto, ntfy.proto, ntfy_signaling.proto, pairing.proto, qr_payload.proto, sessions.proto, signaling.proto, terminal.proto
...
class NtfySignalMessage(betterproto.Message):
    ...
    """Pairing credential exchange (used with PAIR_REQUEST type)"""

    pair_response: "PairResponse" = betterproto.message_field(11)
    """Pairing credential response (used with PAIR_RESPONSE type)"""
...
class PairRequest(betterproto.Message):
    ...
    """session_id for daemon to look up the pairing session"""
