...
class TerminalManager:
    ...
    def __init__(
        ...
        Args:
            ...
            tmux_service: Optional tmux service for window operations (auto-resize on attach).
        """
    ...
    async def on_connection_closed(self, connection_id: str) -> None:
        ...
        """
        logger.debug(
            f"on_connection_closed: {connection_id}, "
            f"attachments: {[(k, list(v)) for k, v in self._attachments.items()]}"
        )
